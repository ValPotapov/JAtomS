...
document.addEventListener("DOMContentLoaded", function () {
	document.querySelectorAll('[mod_jatoms_showcase="container"]').forEach(function (container) {
		let loading = container.querySelector('[mod_jatoms_showcase="loading"]'),
			error = container.querySelector('[mod_jatoms_showcase="error"]'),
			items = container.querySelector('[mod_jatoms_showcase="items"]');
